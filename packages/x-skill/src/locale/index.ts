...
export const messages: Messages = {
  zh: {
    ...
    selectLanguagePrompt:
      "请选择语言 / Please select language (输入数字/enter number)",
    ...
    // 命令行参数错误
    tagValueRequired:
      "错误: --tag 参数需要一个值 / Error: --tag parameter requires a value",
  ...
  en: {
    ...
    welcomeSub:
      "We will help you quickly install the required development skills!",
    selectLanguage: `${emojis.globe} Select language / 请选择语言:`,
    selectLanguagePrompt:
      "Please select language / 请选择语言 (enter number/输入数字)",
    ...
    rateLimitHint:
      "Set GITHUB_TOKEN environment variable to increase limit to 5000 per hour",
...
// 获取支持的语言列表
export const SUPPORTED_LANGUAGES: Language[] = Object.keys(
  messages,
) as Language[];
