...
```typescript
const openAIRequest = XRequest(
  "https://api.example-openai.com/v1/chat/completions",
  {
    headers: {
...
```typescript
const zhipuRequest = XRequest(
  "https://api.example-zhipu.com/api/paas/v4/chat/completions",
  {
    headers: {
      Authorization: "Bearer API_KEY",
    },
...
```typescript
const sparkRequest = XRequest(
  "https://api.example-spark.com/v1/chat/completions",
  {
    headers: {
      Authorization: "Bearer API_KEY",
    },
...
```typescript
const doubaoRequest = XRequest(
  "https://api.example-doubao.com/api/v3/chat/completions",
  {
    headers: {
      Authorization: "Bearer API_KEY",
    },
