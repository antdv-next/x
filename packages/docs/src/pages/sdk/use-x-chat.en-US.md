...
| defaultMessages | Default display messages | MaybeRef\<MessageInfo\<ChatMessage\>[]\> \| (info: { conversationKey?: string }) => MessageInfo\<ChatMessage\>[] \| (info: { conversationKey?: string }) => Promise\<MessageInfo\<ChatMessage\>[]\> | - | - |
...
| requestFallback | Fallback message for failed requests. When not provided, no message will be displayed | MaybeRef\<ChatMessage\> \| (requestParams: Partial\<Input\>,info: { error: Error; errorInfo: any; messages: ChatMessage[], message: ChatMessage }) => ChatMessage\|Promise\<ChatMessage\> | - | - |
| requestPlaceholder | Placeholder message during requests. When not provided, no message will be displayed | MaybeRef\<ChatMessage\> \| (requestParams: Partial\<Input\>, info: { messages: Message[] }) => ChatMessage \| Promise\<Message\> | - | - |
...
| isRequesting                | Whether a request is in progress                                                                  | ComputedRef\<boolean\>                                                                                        | -       | -       |
| isDefaultMessagesRequesting | Whether the default message list is requesting                                                    | ComputedRef\<boolean\>                                                                                        | false   | 2.2.0   |
| messages                    | Current managed message list content                                                              | ShallowRef\<MessageInfo\<ChatMessage\>[]\>                                                                    | -       | -       |
| parsedMessages              | Content translated through `parser`                                                               | ShallowRef\<MessageInfo\<ParsedMessages\>[]\>                                                                 | -       | -       |
